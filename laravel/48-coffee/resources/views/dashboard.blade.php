                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="form-control px-0 mb-2">
                                    ...
                                    <input required class="roboto pb-1" type="number" name="price" placeholder="type a number...">
                                </div>
                                <div class="form-control px-0 mb-2">
                                    ...
                                    @if ($coffee_types)
                                        @foreach ($coffee_types as $coffee_type)
                                            ...
                                            <input required type="radio" id="{{ $coffee_type->coffee_type }}" name="coffee_type" value="coffee_type_name">
                                            <label class="roboto ms-2" for="coffee_type_name2">{{ $coffee_type->coffee_type }}</label><br>
                                ...
                                <div class="form-control px-0 mb-2">
                                    ...
                                    <input required class="roboto pb-1" type="number" name="available" placeholder="type a number...">
                                </div>
                                <div class="form-control px-0">
            ...
            <div class="col-8 dashboard-content bg-dark p-4">
                ...
                @if ($coffee_types)
                    ...
                    <div class="card-album text-start px-4 mt-4" 
                        style="background-color: {{ $coffee_type->bg_color }} !important;">
                        ...
                        <div class="row pt-4 pb-3">
                            ...
                            <div class="col-2 text-end"><button class="btn btn-danger delete-btn shadow-none"
                                data-name="{{ $coffee_type->coffee_type }}" 
                                data-url="{{ route('coffee-type.destroy', $coffee_type->id) }}">Delete</button></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 m-0 pb-4">
                                <div class="card">
                                    <img class="card-img-top h-100" src="../images/coffee/cuban-coffee.jpg" alt="...">
                                    <div class="cover w-100 h-100 p-2">
                                        ...
                                        <button class="float-end shadow-none m-0 px-2 py-1 btn btn-danger" data-name="coffee_name" data-url="COFFEE-NAME URL"><i class="fa-solid fa-trash"></i></button>
                                    </div>
                                    <div class="card-body w-100 h-50 p-2">
                                        <h5 class="card-title text-light">Coffee Name Coffee Name Coffee Name</h5>
                                        <p class="card-text mb-0">Price: <strong class="text-light">&#8369;1000</strong></p>
                                        <p class="card-text mt-0">Available: <strong class="text-light">5 Stacks</strong></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="two-tables py-5">
                    <div class="row">
                        <div class="col-6 text-center mt-4 px-5">
                            ...
                            <table class="w-100">
                                <tr>
                                    <td class="py-3 ps-4"><p class="text-light p-0 m-0">id#</p></td>
                                    <td><p class="text-light p-0 m-0">employee_name</p></td>
                                    <td><p class="text-light p-0 m-0">age</p></td>
                                    <td><p class="text-light p-0 m-0">paranaque</p></td>
                                </tr>
                                <tr>
                                    <td class="py-3 ps-4"><p class="text-light p-0 m-0">id#</p></td>
                                    <td><p class="text-light p-0 m-0">employee_name</p></td>
                        ...
                        <div class="col-6 text-center mt-4 px-5">
                            ...
                            <table class="w-100">
                                <tr>
                                    <td class="py-3 ps-4"><p class="text-light p-0 m-0">id#</p></td>
                                    <td><p class="text-light p-0 m-0">costumer_name</p></td>
                                    <td><p class="text-light p-0 m-0">age</p></td>
                                    <td><p class="text-light p-0 m-0">paranaque</p></td>
                                </tr>
                                <tr>
            ...
            <div class="col-2 dashboard-section bg-dark p-4 sticky-top">
                ...
                <div class="w-100 profile px-3 py-2">
                    <div class="row">
                        ...
                        <div class="col-10"><h6 class="text-light">username</h6></div>
                        <div class="col-2"><p class="text-light py-0 my-1"><i class="fa-solid fa-house"></i></p></div>
                        <div class="col-10"><p class="text-light py-0 my-1">city</p></div>
                        <div class="col-2"><p class="text-light py-0 my-1"><i class="fa-solid fa-screwdriver"></i></p></div>
                        <div class="col-10"><p class="text-light py-0 my-1">employee</p></div>
                    </div>
                </div>
